...
<%
	...
	try{
		PreparedStatement verificarRegistro = dbconect.prepareStatement("SELECT cedula FROM quim_bio where cedula = ?");
		...
		if(resultado.next()){
			...
			RequestDispatcher mensaje = request.getRequestDispatcher("../formularios/formularioQuimica.jsp");
			mensaje.include(request, response);
		}else {
			String insertarsql = "INSERT INTO quim_bio (nombre, cedula, fecha_inicio) VALUES ('"+nombre+"','"+cedula+"','"+fecha+"')";
			dbstatement.executeUpdate(insertarsql);
			String exitoso = "Registro exitoso!";
			request.setAttribute("exitoso", exitoso);
			RequestDispatcher menexitoso = request.getRequestDispatcher("../formularios/formularioQuimica.jsp");
