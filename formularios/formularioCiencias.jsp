...
<body>
    ...
    <nav>
        ...
        <div class="lower_nav">
            <ul>
                ...
                <li><a href="../formularios/formularioQuimica.jsp">Química y Biologí­a</a></li>
                <li><a href="../formularios/formularioProgramacion.jsp">Programación</a></li>
                <li><a href="../referencias/referencias.html">Referencias</a></li>
                <li><a href="../contactenos/contactenos.html">Contáctanos</a></li>
            </ul>
        </div>
    </nav>
    ...
    <section>
        <div class="left-section">
            <h1>Formulario de registro: Ciencias Naturales</h1>
            <div id="componente">
                <form action="../formularios/registroCiencias.jsp">
                    ...
                    <label for="cedula">Cédula<span>*</span></label><br>
                    <input type="text" id="cedula" name="cedula" placeholder="Cédula" class="celda" required><br>
                    <!-- Fecha de inicio -->
        ...
        <div class="right-section">
            <div class="imagen">
                <img src="../assets/cienciasnaturales.gif" alt="ciencias naturales">
            </div>
        </div>
    </section>
    <footer>
