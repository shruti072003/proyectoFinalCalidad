...
<head>
    ...
    <title>Registro Programacion</title>
    <!-- Stylesheet -->
...
<body>
    ...
    <section>
        <div class="left-section">
            <h1>Formulario de registro: Programacion</h1>
            <div id="componente">
                <form action="../formularios/registroProgramacion.jsp">
        ...
        <div class="right-section">
            <div class="imagen">
                <img src="../assets/programming.gif" alt="ciencias naturales" id="img-pro">
            </div>
        </div>
    </section>
    <footer>
